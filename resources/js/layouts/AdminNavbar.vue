                            ...
                            >
                                ...
                                <li class="list-group-item bg-light">
                                    <a href="#" class="text-muted">
                                        ...
                                        <p class="mb-0">
                                            Mauris blandit erat id nunc blandit,
                                            ac eleifend dolor pretium.
                                        </p>
                                    </a>
                                </li>
                                <!-- List group item -->
                                <li class="list-group-item">
                                    <a href="#" class="text-muted">
                                        ...
                                        <p class="mb-0">
                                            ...
                                            elementum id in ante. Maecenas et
                                            sapien metus.
                                        </p>
                                    </a>
                                </li>
                                ...
                                <li class="list-group-item">
                                    <a href="#" class="text-muted">
                                        ...
                                        <p class="mb-0">
                                            ...
                                            sollicitudin sollicitudieget elit
                                            vel pretium.
                                        </p>
                                    </a>
                                </li>
...
export default {
    ...
    mounted() {
        this.user = store.getters.authInfo;
    },
    methods: {
        logout: function () {
            this.$store
