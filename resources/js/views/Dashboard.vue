<template>
    <!-- <div class="mb-3">Dashboard v1</div> -->
        ...
        <div class="col-xl-3 col-lg-6 col-md-12 col-12 mt-6">
            ...
            <div class="card-body">
                ...
                <div class="icon-shape icon-md bg-light-primary text-primary
                    ...
                    <!-- <i data-feather="trello" class="icon-sm"></i> -->
                </div>
                </div>
                <!-- project number -->
                <div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-12 col-12 mt-6">
            ...
            <div class="card-body">
                ...
                <div class="icon-shape icon-md bg-light-primary text-primary
                    ...
                    <!-- <i data-feather="trending-up" class="icon-sm"></i> -->
                </div>
                </div>
                <!-- project number -->
                <div>
...
<script>
import drobBoxlogo from '@/assets/images/brand/dropbox-logo.svg'
...
export default {
    ...
    created() {
        // this.logo = require("@/assets/images/brand/dropbox-logo.svg");
    },
    mounted(){
        feather.replace()
        ...
        if (div) {
            ...
            console.log('Div tidak ditemukan')
        } */
    }
}
</script>
